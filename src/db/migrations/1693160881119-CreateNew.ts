...
export class CreateNew1693160881119 implements MigrationInterface {
    name = 'CreateNew1693160881119'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "category" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        ...
        await queryRunner.query(`CREATE TABLE "product_categories_category" ("product_id" integer NOT NULL, "category_id" integer NOT NULL, PRIMARY KEY ("product_id", "category_id"))`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_product_categories_category"("product_id", "category_id") SELECT "product_id", "category_id" FROM "product_categories_category"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_categories_category" ("product_id" integer NOT NULL, "category_id" integer NOT NULL, PRIMARY KEY ("product_id", "category_id"))`);
        await queryRunner.query(`INSERT INTO "product_categories_category"("product_id", "category_id") SELECT "product_id", "category_id" FROM "temporary_product_categories_category"`);
